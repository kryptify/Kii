...
"""Test the kii specific ZMQ notification interfaces."""
...
from test_framework.test_framework import (
     KIITestFramework, skip_if_no_bitcoind_zmq, skip_if_no_py3_zmq)
...
class KIIZMQTest (KIITestFramework):
    def set_test_params(self):
        ...
        self.set_kii_test_params(4, 3, fast_dip3_enforcement=True, extra_args=[node0_extra_args, [], [], []])

    def run_test(self):
        # Check that kiid has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all kii related ZMQ publisher
