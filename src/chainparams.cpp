 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1651204581, nBits=1e0ffff0, nNonce=5625448, vtx=1)
...
{
    const char* pszTimestamp = "MAY22 Evereything all the time JCC LSF DA AC JAC";
    const CScript genesisOutputScript = CScript() << ParseHex("04418ffccd8e9fccf614b18ab513d7c809e2e4993717c582f9baf6c543a5f7e0b9fbdc0a76744220fcc13b356f07dbdb2e4cfa6e2b1036828b6f1e769b03975551") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nBudgetPaymentsStartBlock = 27594000;
        consensus.nBudgetPaymentsCycleBlocks = 55188000;
        ...
        consensus.defaultAssumeValid = uint256S("0x0000010500290eadc8d44e363107e2dbc17122823be632f2e060fa0be0548f3b"); 
        ...
        genesis = CreateGenesisBlock(1651204581, 5625448, 0x1e0ffff0, 1, 300 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000010500290eadc8d44e363107e2dbc17122823be632f2e060fa0be0548f3b"));
        assert(genesis.hashMerkleRoot == uint256S("0xf73eca724ceb30c4cbf3e6f3fc8a020dd54aeff706794c0c51b451c78ef0dabd"));
        ...
        vSeeds.emplace_back("185.227.110.225");
        vSeeds.emplace_back("185.144.156.174");
        ...
        // KII BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // KII BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // KII BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"KDzn7MnP1deNwZrwu5RJNi1K2a5crBkwiX"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x0000010500290eadc8d44e363107e2dbc17122823be632f2e060fa0be0548f3b")},
            }
        };

        chainTxData = ChainTxData{
            1651204581, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000281b94af8ee1d1840bbc454ee1f5c6aeffb5357fe5ec8b3aaee5f67f993"); 
        ...
        genesis = CreateGenesisBlock(1651204586UL, 1561120UL, 0x1e0ffff0, 1, 300 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000281b94af8ee1d1840bbc454ee1f5c6aeffb5357fe5ec8b3aaee5f67f993"));
        assert(genesis.hashMerkleRoot == uint256S("0xf73eca724ceb30c4cbf3e6f3fc8a020dd54aeff706794c0c51b451c78ef0dabd"));
        ...
        // Testnet KII BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet KII BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet KII BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"TUvFF7WULeovJwN1tZ2xLmkVJNpkrhgrtn"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x00000281b94af8ee1d1840bbc454ee1f5c6aeffb5357fe5ec8b3aaee5f67f993")},
            }
        };

        chainTxData = ChainTxData{
            1651204586, // * UNIX timestamp of last known number of transactions
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        genesis = CreateGenesisBlock(1651204591, 1, 0x207fffff, 1, 300 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0536eac9c3033db04a76022f36e0a30b2f8017a13d48a93b39e4db910f84f05b"));
        assert(genesis.hashMerkleRoot == uint256S("0xf73eca724ceb30c4cbf3e6f3fc8a020dd54aeff706794c0c51b451c78ef0dabd"));

        if (!fHelpOnly) {
            devnetGenesis = FindDevNetGenesisBlock(genesis, 300 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x0536eac9c3033db04a76022f36e0a30b2f8017a13d48a93b39e4db910f84f05b")},
...
public:
    CRegTestParams() {
        ...
        // privKey: 7W3LrFuaMgQ57f5DR7ZFBtnHaywXqPMw7o9VTPnv4AxgjxB5gAN
        vSporkAddresses = {"TGszRahgkEjcUeRLDJMPK36FwTqd4nZUts"};
        nMinSporkKeys = 1;
        ...
        // Regtest KII addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest KII script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Regtest KII BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest KII BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest KII BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
